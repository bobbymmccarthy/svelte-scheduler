...
var app = (function () {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$2, 30, 6, 791);
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1$2.warn(`<Recorder> was created with unknown prop '${key}'`);
    	});
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$1, 90, 4, 2408);
    		},
    		m: function mount(target, anchor) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1$1.warn(`<VoiceRecognition> was created with unknown prop '${key}'`);
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file, 289, 1, 9295);
    			attr_dev(h1, "class", "svelte-11vw19s");
    			add_location(h1, file, 290, 1, 9325);
    			add_location(h2, file, 291, 1, 9341);
    			add_location(br, file, 292, 1, 9383);
    			attr_dev(textarea, "placeholder", "tues before 2pm,\nwed all day,\nthurs 1-2pm, 4-4:30pm,\n...");
    			attr_dev(textarea, "class", "svelte-11vw19s");
    			add_location(textarea, file, 293, 1, 9389);
    			attr_dev(main, "class", "svelte-11vw19s");
    			add_location(main, file, 287, 0, 9239);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
