...
var app = (function () {
    ...
    const file$3 = "src/components/Recorder.svelte";
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$3, 31, 6, 854);
    		},
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file$3, 27, 4, 614);
    			add_location(button1, file$3, 28, 4, 704);
    			add_location(button2, file$3, 29, 4, 770);
    			add_location(div, file$3, 26, 0, 604);
    		},
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	const click_handler_2 = () => iconHandler('SAVE');
    	...
    	return [isActive, iconHandler, click_handler, click_handler_1, click_handler_2];
    }
    ...
    const file$2 = "src/components/VoiceRecognition.svelte";
    ...
    function create_if_block(ctx) {
    	...
    	recorder.$on("recorderHandler", /*recorderHandler*/ ctx[1]);
    	let each_value = getAllTimes();
    	...
    	const block = {
    		c: function create() {
    			...
    			each_1_anchor = empty();
    			add_location(b0, file$2, 118, 7, 3247);
    			add_location(b1, file$2, 118, 30, 3270);
    			add_location(br0, file$2, 118, 60, 3300);
    			add_location(u0, file$2, 119, 21, 3326);
    			add_location(i0, file$2, 119, 60, 3365);
    			add_location(br1, file$2, 119, 73, 3378);
    			add_location(u1, file$2, 120, 27, 3410);
    			add_location(i1, file$2, 120, 41, 3424);
    			add_location(i2, file$2, 120, 61, 3444);
    			add_location(u2, file$2, 120, 79, 3462);
    			add_location(i3, file$2, 120, 94, 3477);
    			add_location(p, file$2, 118, 4, 3244);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    			append_dev(p, b0);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*getAllTimes*/ 0) {
    				each_value = getAllTimes();
    				validate_each_argument(each_value);
    				let i;
    ...
    // (129:4) {#each getAllTimes() as note}
    function create_each_block$1(ctx) {
    	let p;
    	let t_value = /*note*/ ctx[11].content + "";
    	let t;
    	...
    	const block = {
    		c: function create() {
    			p = element("p");
    			t = text(t_value);
    			add_location(p, file$2, 129, 4, 3762);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    			append_dev(p, t);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(129:4) {#each getAllTimes() as note}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	let if_block_anchor;
    	let current;
    	let if_block = /*support*/ ctx[0] && create_if_block(ctx);
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			if (/*support*/ ctx[0]) if_block.p(ctx, dirty);
    		},
    		i: function intro(local) {
    			if (current) return;
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	recognition.onresult = function (event) {
    		...
    		$$invalidate(2, noteContent += transcript);
    	};
    	...
    	function saveHandler() {
    		...
    		if (!noteContent.length) {
    			recordingText = "Could not save empty note. Please add a message to your note.";
    		} else {
    	...
    	$$self.$inject_state = $$props => {
    		if ('noteContent' in $$props) $$invalidate(2, noteContent = $$props.noteContent);
    		if ('times' in $$props) times = $$props.times;
    		if ('support' in $$props) $$invalidate(0, support = $$props.support);
    	...
    	return [support, recorderHandler, noteContent];
    }

    class VoiceRecognition extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { noteContent: 2 });
    ...
    function create_each_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			th = element("th");
    			t = text(t_value);
    			attr_dev(th, "class", "svelte-19nxbg5");
    			add_location(th, file$1, 32, 8, 602);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(32:8) {#each dayArr as day}",
    		ctx
    	});
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			td = element("td");
    			attr_dev(td, "class", "svelte-19nxbg5");
    			toggle_class(td, "available", /*day*/ ctx[7]);
    			add_location(td, file$1, 39, 8, 793);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(38:8) {#each hour as day, j}",
    		ctx
    	});
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			add_location(tr, file$1, 36, 4, 686);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(36:8) {#each timeArr as hour, i}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(tr, file$1, 30, 4, 559);
    			attr_dev(table, "class", "svelte-19nxbg5");
    			add_location(table, file$1, 29, 0, 547);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		if ('timeArr' in $$props) $$invalidate(0, timeArr = $$props.timeArr);
    		if ('dayArr' in $$props) $$invalidate(1, dayArr = $$props.dayArr);
    	};
    ...
    function create_fragment(ctx) {
    	...
    	function voicerecognition_noteContent_binding(value) {
    		/*voicerecognition_noteContent_binding*/ ctx[3](value);
    	}

    	let voicerecognition_props = {};

    	if (/*voice*/ ctx[0] !== void 0) {
    		voicerecognition_props.noteContent = /*voice*/ ctx[0];
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			t6 = space();
    			h2 = element("h2");
    			h2.textContent = "When are you available to meet?";
    			t8 = space();
    			br = element("br");
    			t9 = space();
    			textarea = element("textarea");
    			add_location(p, file, 23, 1, 731);
    			attr_dev(h1, "class", "svelte-11vw19s");
    			add_location(h1, file, 25, 1, 797);
    			add_location(h2, file, 26, 1, 813);
    			add_location(br, file, 27, 1, 855);
    			attr_dev(textarea, "placeholder", "mon 9-10am, 2-3:45pm\nwed all day,\nthurs except 1-2pm,\nfri except 3-4pm and 5-6pm\n...");
    			attr_dev(textarea, "class", "svelte-11vw19s");
    			add_location(textarea, file, 28, 1, 861);
    			attr_dev(main, "class", "svelte-11vw19s");
    			add_location(main, file, 21, 0, 657);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			set_input_value(textarea, /*voiceText*/ ctx[1]);
    			current = true;

    			if (!mounted) {
    				dispose = [
    					listen_dev(textarea, "input", /*textarea_input_handler*/ ctx[4]),
    					listen_dev(textarea, "input", handleInput, false, false, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!updating_noteContent && dirty & /*voice*/ 1) {
    				updating_noteContent = true;
    				voicerecognition_changes.noteContent = /*voice*/ ctx[0];
    				add_flush_callback(() => updating_noteContent = false);
    			}

    			voicerecognition.$set(voicerecognition_changes);
    			if (!current || dirty & /*voice*/ 1) set_data_dev(t2, /*voice*/ ctx[0]);

    			if (dirty & /*voiceText*/ 2) {
    				set_input_value(textarea, /*voiceText*/ ctx[1]);
    			}
    		},
    		i: function intro(local) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function textarea_input_handler() {
    		voiceText = this.value;
    		$$invalidate(1, voiceText);
    	}
    	...
    	$$self.$inject_state = $$props => {
    		if ('text1' in $$props) text1 = $$props.text1;
    		if ('text2' in $$props) text2 = $$props.text2;
    		if ('text3' in $$props) text3 = $$props.text3;
    		if ('voice' in $$props) $$invalidate(0, voice = $$props.voice);
    		if ('voiceText' in $$props) $$invalidate(1, voiceText = $$props.voiceText);
    		if ('timeArr' in $$props) $$invalidate(2, timeArr = $$props.timeArr);
    	};
