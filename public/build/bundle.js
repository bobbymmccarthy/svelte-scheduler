...
var app = (function () {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$2, 31, 6, 854);
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button2, file$2, 29, 4, 770);
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t0 = space();
    			p = element("p");
    			p.textContent = "Press Record to log your availablilty and say it in the form \"I'm free Monday 9 a.m. to 5 p.m\"";
    			t2 = space();
    			...
    			each_1_anchor = empty();
    			add_location(p, file$1, 125, 4, 3374);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*getAllNotes*/ 0) {
    				each_value = getAllNotes$1();
    				validate_each_argument(each_value);
    				let i;
    ...
    // (130:4) {#each getAllNotes() as note}
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			p = element("p");
    			t = text(t_value);
    			add_location(p, file$1, 130, 4, 3628);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    			append_dev(p, t);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(130:4) {#each getAllNotes() as note}",
    		ctx
    	});
    ...
    class VoiceRecognition extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { noteContent: 2 });
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file, 304, 1, 9490);
    			attr_dev(h1, "class", "svelte-11vw19s");
    			add_location(h1, file, 305, 1, 9520);
    			add_location(h2, file, 306, 1, 9536);
    			add_location(br, file, 308, 1, 9580);
    			attr_dev(textarea, "placeholder", "tues before 2pm,\nwed all day,\nthurs 1-2pm, 4-4:30pm,\n...");
    			attr_dev(textarea, "class", "svelte-11vw19s");
    			add_location(textarea, file, 309, 1, 9586);
    			attr_dev(main, "class", "svelte-11vw19s");
    			add_location(main, file, 302, 0, 9416);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(textarea, "input", /*handleInput*/ ctx[2], false, false, false)
    				];
    ...
    function instance($$self, $$props, $$invalidate) {
    		...
    		for (let i = 0; i < lines.length; i++) {
    			...
    			if (fullAvailability.test(line) && !busyIndicator.test(line)) {
    				...
    				if (parsed.length > 0) {
    					...
    					availableTimes[parsed[0].start.get('weekday')] = [
    						[
    							new Date(date.getYear(), date.getMonth(), date.getDay(), MIN_HOUR),
    							new Date(date.getYear(), date.getMonth(), date.getDay(), MAX_HOUR)
    						]
    					];
    				}
    			} else // Handle single or multiple times for day
    	...
    	let allUserTimes = [
    		{
    			user: 'user1',
    			availableTimes: available1
    		},
    		{
    			user: 'user2',
    			availableTimes: available2
    		},
    		{
    			user: 'user3',
    			availableTimes: available3
    		}
    	];
    	...
    	$$self.$capture_state = () => ({
    		...
    		createCalendarFromAvailableTimes,
    		eqSet,
    		isSuperset,
    		getTopNTimes,
    		processText,
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('MIN_HOUR' in $$props) MIN_HOUR = $$props.MIN_HOUR;
    		if ('MAX_HOUR' in $$props) MAX_HOUR = $$props.MAX_HOUR;
    		if ('MIN_MEETING_LENGTH_MIN' in $$props) MIN_MEETING_LENGTH_MIN = $$props.MIN_MEETING_LENGTH_MIN;
    		if ('MIN_TIMEBLOCK_MIN' in $$props) MIN_TIMEBLOCK_MIN = $$props.MIN_TIMEBLOCK_MIN;
    		if ('text1' in $$props) text1 = $$props.text1;
    		if ('text2' in $$props) text2 = $$props.text2;
    		if ('text3' in $$props) text3 = $$props.text3;
    		if ('available1' in $$props) available1 = $$props.available1;
    		if ('available2' in $$props) available2 = $$props.available2;
    		if ('available3' in $$props) available3 = $$props.available3;
    		if ('allUserTimes' in $$props) allUserTimes = $$props.allUserTimes;
    	};
