...
<project version="4">
  ...
  "keyToString": {
    ...
    "nodejs.jest.jest_package": "/Users/wanasit/Workspace/chrono/node_modules/jest",
    "nodejs_package_manager_path": "npm",
    "prettierjs.PrettierConfiguration.Package": "/Users/wanasit/Workspace/chrono/node_modules/prettier",
  ...
  <component name="RunManager" selected="Jest.All Tests">
    ...
    <configuration name="Test - After with reference" type="JavaScriptTestRunnerJest" temporary="true" nameIsGenerated="true">
      <node-interpreter value="project" />
      <node-options value="" />
      <jest-package value="$PROJECT_DIR$/node_modules/jest" />
      <working-dir value="$PROJECT_DIR$" />
      ...
      <test-names>
        <test-name value="Test - After with reference" />
      </test-names>
      <method v="2" />
    </configuration>
    ...
    <configuration name="en_time_units_ago.test.ts" type="JavaScriptTestRunnerJest" temporary="true" nameIsGenerated="true">
      <node-interpreter value="project" />
      <node-options value="" />
      <jest-package value="$PROJECT_DIR$/node_modules/jest" />
      <working-dir value="$PROJECT_DIR$" />
    ...
    <configuration name="en_time_units_casual_relative.test.ts" type="JavaScriptTestRunnerJest" temporary="true" nameIsGenerated="true">
      <node-interpreter value="project" />
      <node-options value="" />
      <jest-package value="$PROJECT_DIR$/node_modules/jest" />
      <working-dir value="$PROJECT_DIR$" />
      <envs />
      <scope-kind value="TEST_FILE" />
      <test-file value="$PROJECT_DIR$/test/en/en_time_units_casual_relative.test.ts" />
      <method v="2" />
    </configuration>
    <configuration name="en_time_units_later.test.ts" type="JavaScriptTestRunnerJest" temporary="true" nameIsGenerated="true">
      <node-interpreter value="project" />
      <node-options value="" />
      <jest-package value="$PROJECT_DIR$/node_modules/jest" />
      <working-dir value="$PROJECT_DIR$" />
    ...
    <list>
      ...
      <item itemvalue="Jest.Test - After with reference" />
      <item itemvalue="Jest.Test - Single Expression" />
      <item itemvalue="Jest.en_time_units_ago.test.ts" />
      <item itemvalue="Jest.en_time_units_casual_relative.test.ts" />
      <item itemvalue="Jest.en_time_units_later.test.ts" />
  ...
  <component name="TaskManager">
    <task active="true" id="Default" summary="Default task">
      ...
      <workItem from="1671942898708" duration="2246000" />
      <workItem from="1673684432556" duration="1442000" />
      <workItem from="1676083612959" duration="425000" />
      <workItem from="1676777563056" duration="31000" />
      <workItem from="1677990934481" duration="6060000" />
    </task>
    <servers />
  </component>
