...
// TODO: the regex for the parser only works in chrome right now. there is a small change to make it work in firefox and other browsers,
// but the change has to be made in the chrono npm package regex (either by modifying the package or by changing it post-build with a script)
